...
class Transaksi extends CI_Controller
{
    ...
    public function select_driver($insert_id)
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($user_driver->status == 0 && $user_driver->saldo_driver >= 1) {
                ...
                $this->send_transaction_ap2($last_transaksi);
    ...
    public function send_transaction_ap2()
    {
        header('Content-type: text/html; charset=utf-8');
        // URL to fetch
        $url = "https://api-ecsysdev.angkasapura2.co.id/api/auth/login";
        ...
        $dataj = array(
            'password' => 'api.mandargama',
            'username' => 'api.mandargama',
        );
        ...
        // $this->send_data_ap2($data);
        print_r($data);
    }

    public function send_data_ap2()
    {
        $data = array(
            "store" => array(
                [
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://api-ecsysdev.angkasapura2.co.id/api/v1/transaction");
        ...
        $headers = [
            ...
            'Authorization:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..0_Sh8VYZkepS8IZCwA8ygAWZUcz9Wncc3kd--Dtc-9A'
        ];
